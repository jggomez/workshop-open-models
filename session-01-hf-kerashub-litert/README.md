...
- **Consumo de Modelos:** Descarga automatica de presets pre-entrenados para vision por computador y procesamiento de lenguaje natural.
...
|---|---|---|---|---|
| **Lab 1** | `01-kerashub-image-classification/` | Script + Notebook | Clasificacion de imagenes con modelos pre-entrenados de vision. | Python, KerasHub, ImageNet |
